...
trait HBaseIndex extends Index {
   ...
   */
  def getTraceIdsByName(serviceName: String, spanNameOption: Option[String], endTs: Long, limit: Int, startTs: Long = 0): Future[Seq[IndexedTraceId]] = {
   ...
   * Only return maximum of limit trace ids from before the endTs.
   */
  def getTraceIdsByAnnotation(serviceName: String, annotation: String, value: Option[ByteBuffer], endTs: Long, limit: Int, startTs: Long = 0): Future[Seq[IndexedTraceId]] = {
